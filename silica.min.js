...
module, exports) {
  ...
  var Silica = {context:window, contextName:"", directives:{}, filters:{}, router:{}, _ifs:{}, _shws:{}, _klass:{}, _watch:{}, _repeat_templates:{}, _isReady:false, _appRoot:null, interpolationPattern:/\{\{(.*?)\}\}/, version:"0.4.2", setContext:function setContext(contextName) {
    ...
    if (!raw.rt_live) {
      ...
      for (var _i2 = attributes.length - 1;_i2 >= 0;--_i2) {
        attribute = attributes[_i2];
