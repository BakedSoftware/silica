  ...
  var Silica = {context:window, contextName:"", directives:{}, filters:{}, router:{}, _ifs:{}, _shws:{}, _klass:{}, _watch:{}, _repeat_templates:{}, interpolationPattern:/\{\{(.*?)\}\}/, setContext:function setContext(contextName) {
    ...
    for (var i = nodes.length - 1;i >= 0;--i) {
      ...
      if (isVisible) {
        ...
        var subNodes = Silica.query(node, "[data-show]");
    ...
    for (i = elements.length - 1;i >= 0;--i) {
      element = elements[i];
      type = element.type;
      if (element !== document.activeElement && (type === "text" || type === "file" || type === "number" || type === "email" || type === "password" || type === "time" || type === "select-one")) {
