...
module, exports) {
  ...
  var Silica = {context:window, contextName:"", directives:{}, filters:{}, router:{}, _ifs:{}, _shws:{}, _klass:{}, _watch:{}, _repeat_templates:{}, _isReady:false, _appRoot:null, interpolationPattern:/\{\{(.*?)\}\}/, version:"0.4.3", setContext:function setContext(contextName) {
    ...
    if (changed === null && Silica._isReady) {
      ...
      for (k in changed) {
        _funcs = changed[k];
        if (obj !== true) {
          for (var _i2 = _funcs.length - 1;_i2 >= 0;--_i2) {
            _func2 = _funcs[_i2];
            _func2[1].apply(_func2[0]);
          }
        } else {
          _funcs = Silica._watch[k];
          for (var _i3 = _funcs.length - 1;_i3 >= 0;--_i3) {
            _func2 = _funcs[_i3];
            _func2[1].apply(_func2[0]);
          }
        }
    ...
    if (raw.tagName === type && !raw.rt_live) {
      var attribute = undefined;
      for (var _i5 = attributes.length - 1;_i5 >= 0;--_i5) {
        attribute = attributes[_i5];
        if (raw.hasAttribute(attribute.substring(1, attribute.length - 1))) {
          filtered.push(root);
          break;
        }
