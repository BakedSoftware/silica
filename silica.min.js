(function e(t, n, r) {
  ...
  var Silica = {context:window, contextName:"", directives:{}, filters:{}, router:{}, _ifs:{}, _shws:{}, _klass:{}, _watch:{}, _repeat_templates:{}, _isReady:false, _appRoot:null, interpolationPattern:/\{\{(.*?)\}\}/, version:"0.5.20", setContext:function setContext(contextName) {
    ...
    var removeWatchers = function removeWatchers(node) {
      if (node._rt_ctrl) {
        ctrl = node._rt_ctrl;
