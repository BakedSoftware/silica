(function e(t, n, r) {
  ...
  var Silica = {context:window, contextName:"", directives:{}, filters:{}, router:{}, _ifs:{}, _shws:{}, _klass:{}, _watch:{}, _repeat_templates:{}, interpolationPattern:/\{\{(.*?)\}\}/, setContext:function setContext(contextName) {
      ...
      if (raw._rt_ctx) {
        ...
        if (raw._rt_ctrl) {
          ...
          if (raw.nodeName === "BODY") {
            ...
            if (raw.nodeType !== 9 && raw.nodeType !== 3 && raw.dataset.controller) {
    ...
    for (var _len5 = arguments.length, attributes = Array(_len5 > 2 ? _len5 - 2 : 0), _key3 = 2;_key3 < _len5;_key3++) {
      attributes[_key3 - 2] = arguments[_key3];
    }
    var isSingle = attributes.length == 1;
    ...
    for (var i = nodes.length - 1;i >= 0;--i) {
      ...
      if (isVisible) {
        ...
        var subNodes = Silica.query(node, "[data-if]");
        ...
        for (i = _i = 0, _len = elements.length;_i < _len;i = ++_i) {
          ...
          if (isVisible) {
            if (element.nodeType === 8) {
              ...
              var _ref3 = undefined;
              if ((_ref3 = Silica.getContext(compiled)) != null) {
            ...
            if (element.nodeType !== 8) {
              ...
              var _ret2 = function() {
                var subNodes = Silica.query(element, "[data-if]");
                var subNode = undefined;
                for (var j = subNodes.length - 1;j >= 0;--j) {
                  subNode = subNodes[j];
                  prop = subNode.dataset["if"];
