(function e(t, n, r) {
  ...
  var Silica = {context:window, contextName:"", directives:{}, filters:{}, router:{}, _ifs:{}, _shws:{}, _klass:{}, _watch:{}, _repeat_templates:{}, interpolationPattern:/\{\{(.*?)\}\}/, version:"0.2.3", setContext:function setContext(contextName) {
      ...
      if (isVisible) {
        ...
        if (node.nodeType !== 8) {
          ...
          var _loop = function _loop(_j2) {
            subNode = subNodes[_j2];
            var ctrl = _this2._rt_ctrl;
          ...
          for (var _j2 = subNodes.length - 1;_j2 >= 0;--_j2) {
            _loop(_j2);
          }
  ...
  }, "scroll-finished":function scrollFinished() {
    var _this3 = this;
        ...
        for (i = _i = 0, _len = elements.length;_i < _len;i = ++_i) {
          ...
          if (isVisible) {
            if (element.nodeType === 8) {
              ...
              var _ref3 = undefined;
              if ((_ref3 = Silica.getContext(compiled[0])) != null) {
                if (typeof _ref3.onLoad === "function") {
                  _ref3.onLoad();
                }
              }
            }
            ...
            if (element.nodeType !== 8) {
              ...
              (function() {
                ...
                for (var _j3 = subNodes.length - 1;_j3 >= 0;--_j3) {
                  subNode = subNodes[_j3];
    ...
    var decache = function decache(node, skip) {
      if (!skip) {
