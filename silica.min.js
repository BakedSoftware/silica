(function e(t, n, r) {
  ...
  function Model() {
    ...
    for (var i = elements.length - 1;i >= 0;i--) {
      ...
      var type = elm.type;
      if (type === "text" || type === "file" || type === "number" || type === "email" || type === "password" || type === "time") {
  ...
  var Silica = {context:window, contextName:"", directives:{}, filters:{}, router:{}, _ifs:{}, _shws:{}, _klass:{}, _watch:{}, _repeat_templates:{}, _isReady:false, _appRoot:null, interpolationPattern:/\{\{(.*?)\}\}/, version:"0.3.3", setContext:function setContext(contextName) {
  ...
  function Model() {
    ...
    for (i = elements.length - 1;i >= 0;--i) {
      element = elements[i];
      type = element.type;
      if (element !== document.activeElement && (type === "text" || type === "file" || type === "number" || type === "email" || type === "password" || type === "time" || type === "select-one" || type === "textarea")) {
